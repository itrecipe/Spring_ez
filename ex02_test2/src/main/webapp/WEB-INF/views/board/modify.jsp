	...
	<div class="row">
		...
		<div class="col-md-10">
			<div id="submain">
				...
				<!-- 시큐리티 적용후 토큰 추가(POST방식은 무조건 추가 해야 한다.) -->
...
<textarea class="form-control" id="content" name="content" rows="10" ><c:out value="${board.content}" />
						</textarea>		
					</div>
					<div class="form-group">
					...
					<sec:authorize access="isAuthenticated">
						<c:if test="${pinfo.username eq board.writer}"> <!-- security에선 username이 ID 값이다. ID와 작성자가 같으면 아래 버튼을 보여주게 처리 -->
							<button type="submit" data-oper='modify' class="btn btn-info">Modify</button>&nbsp;&nbsp;
  							<button type="submit" data-oper='remove' class="btn btn-danger">Remove</button>&nbsp;&nbsp;		
						</c:if>
					</sec:authorize>
