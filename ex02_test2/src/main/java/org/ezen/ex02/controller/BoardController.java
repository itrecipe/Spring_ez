...
public class BoardController {
	...
	public void list(Model model) {
		...
		// return type이 void이면 mapping의 url과 동일한 이름의 jsp(list.jsp)
	}
	*/
	...
	*/
	...
	//시큐리티 적용된 modify
	@PreAuthorize("principal.username == #board.writer") //SEC EL(표현언어)로 작성한다.
	//사전에 인증하게 하는 어노테이션, jsp 쪽에서 통과를 하더라도 여기서 한번더 걸러주는 역할을 함
	...
	public String modify(BoardVO board, Criteria cri, RedirectAttributes rttr) {
		...
		*/
		...
		return "redirect:lsit" + cri.getListLink();
	}
